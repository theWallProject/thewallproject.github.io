...
export const translations = {
  ...
  "downloads.installNow": {
    en: "Install Now (For {{browser}})",
    ar: "ثبت الآن (لـ {{browser}})",
    fr: "Installer maintenant (Pour {{browser}})",
    es: "Instalar ahora (Para {{browser}})",
    de: "Jetzt installieren (Für {{browser}})",
    id: "Instal Sekarang (Untuk {{browser}})",
    nl: "Nu installeren (Voor {{browser}})",
    zh_CN: "立即安装（适用于 {{browser}}）",
    zh_TW: "立即安裝（適用於 {{browser}}）",
  },
  ...
  "features.donate.description": {
    en: "Help us maintain and improve The Wall Addon. Your support enables us to keep the addon free, update the database regularly, and add new features. Every contribution makes a difference!",
    ar: "ساعدنا في الحفاظ على إضافة الجدار وتحسينها. دعمك يمكننا من الحفاظ على الإضافة مجانية وتحديث قاعدة البيانات بانتظام وإضافة ميزات جديدة. كل مساهمة تحدث فرقاً!",
    fr: "Aidez-nous à maintenir et améliorer The Wall Addon. Votre soutien nous permet de garder l'extension gratuite, de mettre à jour la base de données régulièrement et d'ajouter de nouvelles fonctionnalités. Chaque contribution fait la différence !",
    es: "Ayúdanos a mantener y mejorar The Wall Addon. Tu apoyo nos permite mantener la extensión gratuita, actualizar la base de datos regularmente y agregar nuevas funciones. ¡Cada contribución marca la diferencia!",
    de: "Helfen Sie uns, The Wall Addon zu pflegen und zu verbessern. Ihre Unterstützung ermöglicht es uns, das Addon kostenlos zu halten, die Datenbank regelmäßig zu aktualisieren und neue Funktionen hinzuzufügen. Jeder Beitrag macht einen Unterschied!",
    id: "Bantu kami memelihara dan meningkatkan The Wall Addon. Dukungan Anda memungkinkan kami menjaga addon tetap gratis, memperbarui database secara teratur, dan menambahkan fitur baru. Setiap kontribusi membuat perbedaan!",
    nl: "Help ons The Wall Addon te onderhouden en te verbeteren. Uw steun stelt ons in staat de addon gratis te houden, de database regelmatig bij te werken en nieuwe functies toe te voegen. Elke bijdrage maakt het verschil!",
    zh_CN:
      "帮助我们维护和改进 The Wall 插件。您的支持使我们能够保持插件免费，定期更新数据库，并添加新功能。每一份贡献都很重要！",
    zh_TW:
      "幫助我們維護和改進 The Wall 插件。您的支持使我們能夠保持插件免費，定期更新數據庫，並添加新功能。每一份貢獻都很重要！",
  },
  "footer.github": {
    en: "GitHub",
    ar: "جيت هب",
