...
const BRICK_ASSETS = [
  "/files/walls/wall1.webp",
  "/files/walls/wall2.webp",
  "/files/walls/wall3.webp",
  "/files/walls/wall4.webp",
  "/files/walls/wall5.webp",
  "/files/walls/wall6.webp",
  "/files/walls/wall7.webp",
];

const LOGO_FILES = [
  "/files/logos/Adama_Logo.svg.webp",
  "/files/logos/AI21-Labs-Logo.webp",
  "/files/logos/Amdocs-2017-brand-mark.svg.webp",
  "/files/logos/Ankori.svg.webp",
  "/files/logos/Arava_Logo.svg.webp",
  "/files/logos/Ayalon_Logo_Hebrew_RGB_Short_Dark.svg.png",
  "/files/logos/B144_logo.webp",
  "/files/logos/Check_Point_logo_2022.svg.webp",
  "/files/logos/Coca-Cola-logo.webp",
  "/files/logos/Decart_Logo.svg.webp",
  "/files/logos/fiverr-freelance-service-thumbnail.webp",
  "/files/logos/Logo_of_NSO_Group.svg",
  "/files/logos/McDonalds-Logo-2003.webp",
  "/files/logos/nestle_logo.webp",
  "/files/logos/SimilarWeb-logo-8.webp",
  "/files/logos/starbucks-logo-png-transparent.webp",
  "/files/logos/Teva_Pharmaceuticals_logo.webp",
  "/files/logos/unnamed (2).webp",
